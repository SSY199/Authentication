    ...
    >
      <div className="p-8">
        ...
        {!submmitted ? (
          ...
          >
            <div className="mb-4">
              <p className="text-gray-300 mb6 text-center">
            ...
            <motion.button
             ...
             transition duration-200"
              ...
              whileTap={{ scale: 0.95 }}
            >
              {loading ? <Loader className="animate-spin mr-2 inline-block" /> : 'Send Reset Link'}
            </motion.button>
          </form>
        ) : (
      ...
      >
        <Mail className="h-8 w-8 text-white" aria-label="Mail icon" />
      </motion.div>
      ...
      <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
        <Link to="/login" className="text-green-500 hover:text-green-400 flex items-center text-sm transition-colors duration-300">
